...
/**
 * @brief Routine to compute crowding distance based on objective function values when the population is in the form of a list.
 * @param pop The population pointer.
 * @param lst The list of individuals in the population.
 * @param front_size The size of the front.
 */
...
/**
 * @brief Routine to compute crowding distance based on objective function values when the population is in the form of an array.
 * @param pop The population pointer.
 * @param c1 The start index of the front.
 * @param c2 The end index of the front.
 */
...
/**
 * @brief Routine to compute crowding distances.
 * @param pop The population pointer.
 * @param dist The array of distances.
 * @param obj_array The array of objective values.
 * @param front_size The size of the front.
 */
