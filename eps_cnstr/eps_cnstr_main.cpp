...
int main(
    ...
    */
    if (option == 1) { //ipopt Opt3
        EpsConstraint eps_constr(base_scenario_json, scenario_json, path_out, pollutant_idx, evaluate_cast, exec_path, base_scenario_uuid, base_scenario_str, pso_exec_uuid);
