...
public:
    ...
    EpsConstraint(const json& base_scenario_json, const json& scenario_json, const std::string base_scenario_name, const std::string& path_out, int pollutant_idx, bool evaluate_cast);
