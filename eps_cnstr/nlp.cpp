/**
 * @file nlp.cpp
 * @brief Implementation of the EPA_NLP class and related functions for environmental optimization.
 *
 * This file implements a nonlinear programming (NLP) formulation that uses scenario data (in JSON format)
 * to optimize BMP (Best Management Practices) selection and application. It also uses Redis for ETA lookups
 * and reads/writes Parquet/JSON/CSV files.
 */
 ...
 namespace rnd
 {
      ...
      * @return true if a random draw is less than p, false otherwise.
      */
     ...
     /**
      * @brief Returns a random integer between n and m (inclusive).
      *
      * @param n The lower bound.
      * @param m The upper bound.
      * @return A random integer between n and m.
      */
     ...
     /**
      * @brief Returns a random double between n and m.
      *
      * @param n The lower bound.
      * @param m The upper bound.
      * @return A random double between n and m.
      */
 ...
 /**
  * @brief Constructor for the EPA_NLP class.
  *
  * Initializes the EPA_NLP instance with given scenario JSON data, output path, and pollutant index.
  *
  * @param base_scenario_json The JSON object containing the base scenario.
  * @param scenario_json The JSON object containing scenario-specific parameters.
  * @param path_out The output path where result files will be saved.
  * @param pollutant_idx The index of the pollutant to optimize.
  */
 ...
 /**
  * @brief Updates the reduction constraint based on the current iteration and maximum constraint.
  *
  * @param max_constr The maximum constraint value.
 ...
 /**
  * @brief Destructor for the EPA_NLP class.
  */
 EPA_NLP::~EPA_NLP() {}
 
 /**
  * @brief Retrieves NLP problem dimensions and sparsity information.
  *
  * @param[out] n Number of variables.
  * @param[out] m Number of constraints.
  * @param[out] nnz_jac_g Number of nonzeros in the Jacobian.
  * @param[out] nnz_h_lag Number of nonzeros in the Hessian of the Lagrangian.
  * @param[out] index_style The index style (C or Fortran style).
 ...
 /**
  * @brief Computes and stores the efficiency keys.
  *
  * This function extracts the keys from the efficiency_ map and sorts them.
  */
  ...
  */
 /**
  * @brief Filters the efficiency keys by removing invalid entries.
  *
  * This function connects to Redis to check for the existence of ETA entries and valid BMP costs.
  * It removes keys that do not meet the required criteria.
  */
 ...
 /**
  * @brief Computes the number of decision variables and constraints based on efficiency keys.
  *
  * This function iterates over the efficiency keys and counts the variables (each BMP) and
  * adds one constraint per BMP group.
  */
 ...
 /**
  * @brief Computes the ETA values for each BMP.
  *
  * This function queries the Redis database for ETA values associated with each BMP and stores
  * them in the eta_dict_ member variable.
  */
 ...
 /**
  * @brief Computes the loads for a set of parcels.
  *
  * This function computes pollutant loads by summing over each parcel using the phi values and amounts.
  *
  * @param parcel_keys The keys identifying the parcels.
  * @param phi_dict The dictionary mapping parcel keys to phi values.
  * @param amount The dictionary mapping parcel keys to amount values.
  * @return A vector of computed load sums for each pollutant.
  */
 ...
 /**
  * @brief Retrieves the scenario data string.
  *
  * @return The scenario data as a string.
  */
 ...
 /**
  * @brief Retrieves the unique identifier (UUID) for the current scenario.
  *
 ...
 /**
  * @brief Loads and initializes the EPA_NLP instance using JSON scenario data.
  *
  * This function validates the presence of required keys, processes efficiency and BMP cost
  * information, and sets up internal data structures.
  *
  * @param base_scenario_json The base scenario JSON data.
  * @param scenario_json The scenario-specific JSON data.
  */
 ...
 /**
  * @brief Provides variable and constraint bounds.
  *
  * Sets the lower and upper bounds for the decision variables and constraints.
  *
  * @param n The number of variables.
  * @param x_l Array of lower bounds for variables.
  * @param x_u Array of upper bounds for variables.
  * @param m The number of constraints.
  * @param g_l Array of lower bounds for constraints.
  * @param g_u Array of upper bounds for constraints.
  * @return true if successful.
  */
 ...
 /**
  * @brief Provides the starting point for the NLP.
  *
  * Initializes the decision variables with a greedy solution.
  *
  * @param n The number of variables.
  * @param init_x Boolean flag indicating if x should be initialized.
  * @param x Array to store the starting point values.
  * @param init_z Boolean flag indicating if z (bound multipliers) should be initialized.
  * @param z_L Array for lower bound multipliers (unused).
  * @param z_U Array for upper bound multipliers (unused).
  * @param m The number of constraints.
  * @param init_lambda Boolean flag indicating if lambda (constraint multipliers) should be initialized.
  * @param lambda Array for constraint multipliers (unused).
  * @return true if successful.
  */
  ...
  *
  * Computes the total cost as the weighted sum of BMP costs.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param obj_value Reference to store the computed objective value.
  * @return true if successful.
  */
 bool EPA_NLP::eval_f(
         Index n,
  ...
  *
  * Computes the gradient by differentiating the cost with respect to each decision variable.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param grad_f Array to store the computed gradient values.
  * @return true if successful.
  */
 ...
 /**
  * @brief Evaluates the constraint functions.
  *
  * This function wraps the proxy evaluation function.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param m Number of constraints.
  * @param g Array to store constraint function values.
  * @return true if successful.
  */
 bool EPA_NLP::eval_g(
         Index n,
 ...
 /**
  * @brief Proxy function for evaluating the constraints.
  *
  * Computes the pollutant load and other constraint-related values.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param m Number of constraints.
  * @param g Array to store constraint values.
  * @param is_final Flag indicating if this is the final evaluation (affects output).
  * @return true if successful.
  */
 ...
 /**
  * @brief Evaluates the Jacobian of the constraints.
  *
  * If the values pointer is NULL, the structure (row and column indices) of the Jacobian is returned.
  * Otherwise, the Jacobian values are computed.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param m Number of constraints.
  * @param nele_jac Number of nonzero elements in the Jacobian.
  * @param iRow Array to store the row indices of the Jacobian.
  * @param jCol Array to store the column indices of the Jacobian.
  * @param values Array to store the Jacobian values (if not NULL).
  * @return true if successful.
  */
  ...
  *
  * This function is not fully implemented and returns false.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  * @param new_x Flag indicating if x is new.
  * @param obj_factor Factor multiplying the objective in the Hessian.
  * @param m Number of constraints.
  * @param lambda Array of constraint multipliers.
  * @param new_lambda Flag indicating if lambda is new.
  * @param nele_hess Number of nonzero elements in the Hessian.
  * @param iRow Array to store row indices of Hessian nonzeros.
  * @param jCol Array to store column indices of Hessian nonzeros.
  * @param values Array to store Hessian values (if not NULL).
 ...
 /**
  * @brief Saves the solution files in CSV and JSON formats.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  */
 ...
 /**
  * @brief Reads land data from a Parquet file.
  *
  * Reads a Parquet file containing land BMP information and returns a vector of tuples.
  *
  * @param filename The file path to the Parquet file.
  * @return A vector of tuples containing: AgencyId, StateId, BmpId, GeographyId, LoadSourceGroupId, UnitId, Amount.
  */
 ...
 /**
  * @brief Writes land data to a Parquet file.
  *
  * This function writes a vector of land data tuples to a Parquet file.
  *
  * @param x A vector of tuples representing land data.
  * @param out_filename The output file path.
 ...
 /**
  * @brief Writes land BMP data to a Parquet file.
  *
  * This function converts the input tuple vector into the required format and calls write_land_barefoot.
  *
  * @param lc_x A vector of tuples containing land BMP data.
  * @param out_filename The output file path.
  * @return The number of records written.
  */
 ...
 /**
  * @brief Writes land data to a JSON file.
  *
  * Converts the land BMP data into a JSON object and writes it to a file.
  *
  * @param lc_x A vector of tuples containing land BMP data.
  * @param out_filename The output file path.
 ...
 /**
  * @brief Saves internal solution data for further processing.
  *
  * This function processes solution data into the ef_x_ vector.
  *
  * @param n Number of variables.
  * @param x Array of decision variable values.
  */
 ...
 /**
  * @brief Writes the solution to various output files.
  *
  * This function outputs the final solution (objective value, constraints, BMP selections) to CSV, JSON,
  * and Parquet files.
  *
  * @param n Number of variables.
  * @param x Array of final decision variable values.
  * @param m Number of constraints.
 ...
 /**
  * @brief Appends land BMP data to the internal lc_x_ vector.
  *
  * @param lc_x A vector of tuples containing land BMP data.
  */
 ...
 /**
  * @brief Finalizes the solution after optimization.
  *
  * Writes solution files in various formats and performs any final processing.
  *
  * @param status The solver return status.
  * @param n Number of variables.
  * @param x Array of final decision variable values.
  * @param z_L Array of lower bound multipliers.
  * @param z_U Array of upper bound multipliers.
  * @param m Number of constraints.
  * @param g Array of final constraint values.
  * @param lambda Array of final constraint multipliers.
  * @param obj_value The final objective function value.
  * @param ip_data Pointer to Ipopt data.
  * @param ip_cq Pointer to Ipopt calculated quantities.
  */
