...
int main (int argc, char *argv[]) {
    ...
    std::string base_scenario_name = "base_scenario";
    std::string out_dir = "out";

    std::string manure_nutrients_file = "manure_nutrients.json";
    PSO pso(nparts, nobjs, max_iter, w, c1, c2, lb, ub, input_filename, scenario_filename, out_dir, false, true, true, true, manure_nutrients_file, base_scenario_name);
    pso.optimize();
